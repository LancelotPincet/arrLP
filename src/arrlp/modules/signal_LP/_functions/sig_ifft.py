...
def sig_ifft(array, *,
        ...
        **kwargs) :
    '''
    Fast Inverse Fourier Transform on signals.
    '''
    ...
    if parallel :
        func = lambda array, *args, axes=None, **kwargs : _scipyx.fft.ifft(_scipyx.fft.ifftshift(array, axes=axes), *args, axis=axes[0], workers=-1, **kwargs)
    else :
        func = lambda array, *args, axes=None, **kwargs : _scipyx.fft.ifft(_scipyx.fft.ifftshift(array, axes=axes), *args, axis=axes[0], **kwargs)
    ndims = 1
