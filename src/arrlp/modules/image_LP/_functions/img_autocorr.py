...
# Initializations
def _img_autocorr(self, out, array) :
    array  = array.copy()
...
def par_img_autocorr(self, out, array) :
    array  = array.copy()
    array  -= array.mean(axis=self.axes, keepdims=True)
...
# Main function
img_autocorr = FunctionArray(
    
    # Mandatory
    ndims = 2,
    cpu_function = _img_autocorr,
    par_function = par_img_autocorr,
    gpu_function = _img_autocorr,
    out_function = None,
    ini_function = None,
