...
To finish, some routines may be provided with the library **arrLP** :doc:`(see Reference Guide) <routines>`.
To use them, you can just download `routines source codes <https://github.com/LancelotPincet/arrLP/tree/main/src/arrlp/routines>`_.
...
Now, you can clone in your current directory the `source code folder <https://github.com/LancelotPincet/arrLP>`_ with the following command
