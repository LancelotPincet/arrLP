...
- The library is organized under `src/arrlp` into two main parts:
...
- The main object is defined in:
  - `myname.py`
  - and imported as: `from arrlp import myname`
...
- All such objects become importable from the package root directly with ```from arrlp import myname```.
